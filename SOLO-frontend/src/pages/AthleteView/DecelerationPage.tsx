...
const DecelerationPage: React.FC = () => {
  ...
  const data: Record<Range, { averageSpeed: string; dateRange: string; chartData: ChartData }> = {
    W: {
      averageSpeed: "-2.5 m/s²",
      dateRange: "Oct 21–27, 2024",
      chartData: {
        labels: ["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"],
        data: [0.33, 0.39, 0.37, 0.35, 0.34, 0.32, 0.35],
      },
    },
    M: {
      averageSpeed: "-2.7 m/s²",
    ...
    <IonPage>
      <IonHeader>
        <div className="performance-header">
          ...
          <h1 className="header-title">Deceleration</h1>
        </div>
      </IonHeader>
      <IonContent>
      <div style={{ padding: "16px" }}>
          ...
          <div style={{ marginTop: "1rem" }}>
            <h3>Highlights</h3>
            <p>
              <strong>Thursday:</strong> Achieved the fastest reaction time of
              0.32 m/s. This demonstrates significant improvement and peak performance for the week!
            </p>
            <h3>Challenges</h3>
            <p>
              <strong>Sunday:</strong> The slowest day with 0.39 m/s, likely
...
export default DecelerationPage;
